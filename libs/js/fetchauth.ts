...
// interface Window {  localStorage: ()=>{} , fetch, Headers, location, btoa, atob }

// declare global { interface window { btoa?: typeof btoa }}
  ...
  const
    ...
    fetchAuth = (url, opt: any = {}) => {

      const
        headers = opt.headers || (opt.headers = new Headers());
